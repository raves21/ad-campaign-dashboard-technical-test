  ...
  return (
    <div className="w-full p-6 border-2 flex flex-col gap-4 border-gray-300 rounded-xl">
      ...
      <div className="flex items-center gap-3">
        <div className="bg-blue-200 rounded-full py-1 w-[80px] grid place-items-center font-medium text-xs">
          ID: {campaign.id}
        </div>
        <div className="bg-yellow-200 rounded-full py-1 w-[80px] grid place-items-center font-medium text-xs">
